...
events_name = ['event_2022_1_26', 'event_2022_3_16', 'event_2022_5_4', 'event_2022_6_15', 'event_2022_7_27', 'event_2022_9_21']
        ...
        if start_time < stop_time:
            ...
            for event, event_name in zip(events, events_name):
                ...
                if ret > 0 and calmarRatio > 1.2:
                    nice_output += 1
                    if nice_output >= 3:
                        save_csv(list_=[start_time, stop_time, K_loss], path='eventOutput_2022.csv')
                        print(start_time, stop_time, K_loss)


# %%

params = pd.read_csv('eventOutput_2022.csv', header=None)
