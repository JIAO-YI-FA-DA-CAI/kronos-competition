...
#============================================================================================
    # Table of results statistics
    if type == 'Multiple':
        statistics=self.get_CAR_dist().reset_index(drop=False)
        statistics=statistics.rename(columns={"index":"#"}).to_dict('list')
        last_row, last_col = print_table(wb, ws, 8, last_col+2, statistics, "Table of Statistics")
#============================================================================================
